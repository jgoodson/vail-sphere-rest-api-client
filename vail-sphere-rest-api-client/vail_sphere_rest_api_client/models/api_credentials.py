...
if TYPE_CHECKING:
    from ..models.api_credentials_challenge_responses import ApiCredentialsChallengeResponses


T = TypeVar("T", bound="ApiCredentials")
...
class ApiCredentials:
    ...
    Attributes:
        ...
        challenge_responses (Union[Unset, ApiCredentialsChallengeResponses]): The responses for the given challenge.
    ...
    challenge_responses: Union[Unset, "ApiCredentialsChallengeResponses"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        challenge_responses: Union[Unset, ApiCredentialsChallengeResponses]
        if isinstance(_challenge_responses, Unset):
            challenge_responses = UNSET
        else:
            challenge_responses = ApiCredentialsChallengeResponses.from_dict(_challenge_responses)
        ...
        api_credentials.additional_properties = d
