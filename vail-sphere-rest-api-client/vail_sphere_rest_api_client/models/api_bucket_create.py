...
from ..models.api_bucket_create_control import ApiBucketCreateControl
from ..models.api_bucket_create_versioning import ApiBucketCreateVersioning
...
T = TypeVar("T", bound="ApiBucketCreate")


@attr.s(auto_attribs=True)
class ApiBucketCreate:
    """
    Attributes:
        ...
        compress (Union[Unset, bool]): True if compression should be attempted for all clones of objects stored in the
            bucket Default: True.
        control (Union[Unset, ApiBucketCreateControl]): Bucket ownership control
        ...
        versioning (Union[Unset, ApiBucketCreateVersioning]): Bucket versioning status
    """
    ...
    control: Union[Unset, ApiBucketCreateControl] = UNSET
    ...
    versioning: Union[Unset, ApiBucketCreateVersioning] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        control: Union[Unset, ApiBucketCreateControl]
        if isinstance(_control, Unset):
            control = UNSET
        else:
            control = ApiBucketCreateControl(_control)
        ...
        versioning: Union[Unset, ApiBucketCreateVersioning]
        if isinstance(_versioning, Unset):
            versioning = UNSET
        else:
            versioning = ApiBucketCreateVersioning(_versioning)

        api_bucket_create = cls(
            name=name,
            acls=acls,
        ...
        api_bucket_create.additional_properties = d
        return api_bucket_create
