...
class ApiBucketUpdate:
    ...
    Attributes:
        ...
        compress (Union[Unset, bool]): True if compression should be attempted for all clones of objects stored in the
            bucket Default: True.
        control (Union[Unset, ApiBucketUpdateControl]): Bucket ownership control
    ...
    control: Union[Unset, ApiBucketUpdateControl] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        control: Union[Unset, ApiBucketUpdateControl]
        if isinstance(_control, Unset):
            control = UNSET
        else:
            control = ApiBucketUpdateControl(_control)
        ...
        versioning: Union[Unset, ApiBucketUpdateVersioning]
        if isinstance(_versioning, Unset):
            versioning = UNSET
        else:
            versioning = ApiBucketUpdateVersioning(_versioning)

        api_bucket_update = cls(
            acls=acls,
        ...
        api_bucket_update.additional_properties = d
        return api_bucket_update
