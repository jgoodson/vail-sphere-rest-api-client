...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[ApiSystem]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[ApiSystem]:
    return Response(
