...
def _get_kwargs(
    *,
    ...
    url = "{}/sl/api/updates/endpoints".format(client.base_url)
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[List["ApiEndpointUpdateVersion"]]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[List["ApiEndpointUpdateVersion"]]:
    return Response(
