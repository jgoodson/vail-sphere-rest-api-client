...
from ...models.api_s3_other_parameters import ApiS3OtherParameters
...
def _get_kwargs(
    id: str,
    *,
    body: ApiS3OtherParameters,
) -> Dict[str, Any]:
    headers: Dict[str, Any] = {}

    _kwargs: Dict[str, Any] = {
        "method": "post",
        "url": f"/sl/api/targets/{id}/s3other",
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Get list of buckets for AWS S3 target
