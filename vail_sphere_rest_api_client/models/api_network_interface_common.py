...
T = TypeVar("T", bound="ApiNetworkInterfaceCommon")


@_attrs_define
class ApiNetworkInterfaceCommon:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        api_network_interface_common = cls(
            addresses=addresses,
            auto6=auto6,
            dhcp4=dhcp4,
            dhcp_dns=dhcp_dns,
        ...
        api_network_interface_common.additional_properties = d
        return api_network_interface_common
