...
T = TypeVar("T", bound="ApiS3BucketUpdate")


@attr.s(auto_attribs=True)
class ApiS3BucketUpdate:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        api_s3_bucket_update.additional_properties = d
        return api_s3_bucket_update
