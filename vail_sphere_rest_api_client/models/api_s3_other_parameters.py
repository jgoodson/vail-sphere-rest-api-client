...
T = TypeVar("T", bound="ApiS3OtherParameters")


@_attrs_define
class ApiS3OtherParameters:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        api_s3_other_parameters.additional_properties = d
        return api_s3_other_parameters
