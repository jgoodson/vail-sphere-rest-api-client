...
T = TypeVar("T", bound="ApiNetworkInterface")


@attr.s(auto_attribs=True)
class ApiNetworkInterface:
    """
    Attributes:
        mtu (int): Maximum Transmission Unit
        name (str): Interface Device Name
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        api_network_interface.additional_properties = d
        return api_network_interface
