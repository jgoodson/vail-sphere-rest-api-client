...
if TYPE_CHECKING:
    from ..models.api_sphere_token_challenge_parameters import ApiSphereTokenChallengeParameters


T = TypeVar("T", bound="ApiSphereToken")


@attr.s(auto_attribs=True)
class ApiSphereToken:
    """
    Attributes:
        challenge_name (Union[Unset, str]): The challenge that must be passed first.
        challenge_parameters (Union[Unset, ApiSphereTokenChallengeParameters]): The challenge parameters for the given
            challenge.
    ...
    challenge_parameters: Union[Unset, "ApiSphereTokenChallengeParameters"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        challenge_parameters: Union[Unset, ApiSphereTokenChallengeParameters]
        if isinstance(_challenge_parameters, Unset):
            challenge_parameters = UNSET
        else:
            challenge_parameters = ApiSphereTokenChallengeParameters.from_dict(_challenge_parameters)
        ...
        api_sphere_token.additional_properties = d
        return api_sphere_token
